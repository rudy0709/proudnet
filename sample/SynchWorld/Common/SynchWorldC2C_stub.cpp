...
#include "SynchWorldC2C_stub.h"


const unsigned char sz_SynchWorldC2C_stub_hRmi[] = 
...
namespace SynchWorldC2C {
	...
	bool Stub::ProcessReceivedMessage(::Proud::CReceivedMessage &pa, void* hostTag) 
	{
#ifndef __FreeBSD__ 
		{
			...
			unsigned char x = sz_SynchWorldC2C_stub_hRmi[0]; 
			x++; 
		}
#endif
			...
			case Rmi_P2P_LocalHero_Move:
				{
					...
					// Call this method.
					bool __ret = P2P_LocalHero_Move (remote,ctx , position, velocity, direction );
...
__fail:
	...
	#endif
	const PNTCHAR* Stub::RmiName_First = RmiName_P2P_LocalHero_Move;
