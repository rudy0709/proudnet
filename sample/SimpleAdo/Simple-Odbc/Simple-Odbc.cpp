...
void MsSqlTest()
{
	...
	String uid = _PNT("tester");
	String passwd = _PNT("12345");
	String connStr = _PNT("DSN=MsSql;UID=tester;PWD=12345");
...
void MySqlTest()
{
	...
	String uid = _PNT("tester");
	String passwd = _PNT("12345");
	String connStr = _PNT("DSN=MySql;UID=tester;PWD=12345");
