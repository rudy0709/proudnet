...
namespace ChatC2C {
	...
	{
	public:
	virtual bool P2P_Chat ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext , const Proud::HostID & p2pGroupID, const Proud::String & text) PN_SEALED; 
	virtual bool P2P_Chat ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext, const Proud::HostID & p2pGroupID, const Proud::String & text)   PN_SEALED;  
