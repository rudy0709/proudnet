...
namespace Proud
{
	...
	void COdbcCommandImpl::Prepare(COdbcConnection &conn, const String& query)
	{
		...
		m_paramsMaxCount = GetSpecifiedCharacterCount(m_query, '?');
			...
			for (int loop = 0; loop < paramsCount; loop++)
			{
				...
				switch (param->m_value.GetType())
				{
					...
					case OdbcDataType_BOOL:
						cType = SQL_C_BIT;
						sqlType = (param->m_sqlType != OdbcSqlDataType_UNKNOWN) ? param->m_sqlType : OdbcSqlDataType_BIT;
						break;
...
#else
						sqlType = (param->m_sqlType != OdbcSqlDataType_UNKNOWN) ? param->m_sqlType : OdbcSqlDataType_WCHAR;
#endif
						columnSize = 1;
					...
					case OdbcDataType_SINT8:
						...
						sqlType = (param->m_sqlType != OdbcSqlDataType_UNKNOWN) ? param->m_sqlType : OdbcSqlDataType_TINYINT;
						break;
					...
					case OdbcDataType_SINT16:
						cType = SQL_C_SSHORT;
						sqlType = (param->m_sqlType != OdbcSqlDataType_UNKNOWN) ? param->m_sqlType : OdbcSqlDataType_SMALLINT;
						break;
					...
					case OdbcDataType_SINT32:
						cType = SQL_C_SLONG;
						sqlType = (param->m_sqlType != OdbcSqlDataType_UNKNOWN) ? param->m_sqlType : OdbcSqlDataType_INTEGER;
						break;
					...
					case OdbcDataType_SINT64:
						cType = SQL_C_SBIGINT;
						sqlType = (param->m_sqlType != OdbcSqlDataType_UNKNOWN) ? param->m_sqlType : OdbcSqlDataType_BIGINT;
						break;
					...
					case OdbcDataType_FLOAT:
						cType = SQL_C_FLOAT;
						sqlType = (param->m_sqlType != OdbcSqlDataType_UNKNOWN) ? param->m_sqlType : OdbcSqlDataType_FLOAT;
						break;
					case OdbcDataType_DOUBLE:
						cType = SQL_C_DOUBLE;
						sqlType = (param->m_sqlType != OdbcSqlDataType_UNKNOWN) ? param->m_sqlType : OdbcSqlDataType_DOUBLE;
						break;
...
#else
						sqlType = (param->m_sqlType != OdbcSqlDataType_UNKNOWN) ? param->m_sqlType : OdbcSqlDataType_WVARCHAR;
#endif
					...
					case OdbcDataType_BYTE:
						cType = SQL_C_BINARY;
						sqlType = (param->m_sqlType != OdbcSqlDataType_UNKNOWN) ? param->m_sqlType : OdbcSqlDataType_VARBINARY;
						{
					...
					case OdbcDataType_TIMESTAMP:
						...
						sqlType = (param->m_sqlType != OdbcSqlDataType_UNKNOWN) ? param->m_sqlType : OdbcSqlDataType_TIMESTAMP;
