...
namespace Proud
{
	...
	class CNetClientManager :
		...
		public CSingleton<CNetClientManager>
	{
	public:
	...
	private:
		// 메인 모듈이 전역변수로 선언되더라도 파괴 순서를 지키기 위해
	...
	public:
		void OnCustomValueEvent(CustomValueEvent customValue);
...
//		void ProcessIoEvent(CNetworkerLocalVars &lv, uint32_t waitTime);
	...
	public:
		...
		//PROUDNET_VOLATILE_ALIGN bool m_stopThread;
	...
	private:
		...
		TimerEventHandle m_heartbeatTimerID;
	public:
		//PROUDNET_VOLATILE_ALIGN bool m_useNetworkerThread;
	...
	private:
		...
		static void PostHeartbeatEvent(void* ctx);
