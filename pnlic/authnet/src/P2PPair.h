...
namespace Proud 
{
	...
	public:
		...
		CRemoteClient_S *m_firstClient,*m_secondClient;
...
//		int m_clientUdpRecycleSuccessCount = 0;
		...
		CRemoteClient_S* GetOppositePeer(CRemoteClient_S* peer);
	...
	typedef RefCount<P2PConnectionState> P2PConnectionStatePtr;
