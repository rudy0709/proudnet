...
namespace Proud 
{
	...
	public:
		String m_localAddr;
		FastSocketPtr m_ssdpSocket;
		SsdpState m_ssdpState;
		int m_ssdpRequestCount;
		ByteArray m_ssdpResponseBuffer;

		PROUDNET_VOLATILE_ALIGN bool m_sendIssued; // true-false-true 문제를 피하기 위해 선 true후 issue fail시 false해야 하겠다.
		PROUDNET_VOLATILE_ALIGN bool m_recvIssued;
