...
namespace Proud
{	
	int LibSignature = PROUDNET_H_LIB_SIGNATURE;
...
/*	// "new ByteArray" 자체를 성능 강화하기 위함 
	...
	void ShowLibSignatureMismatchError()
	{
#if defined(_WIN32)
		::MessageBox(NULL,_PNT("Library and header files version mismatch!"), _PNT("ProudNet"), MB_OK|MB_ICONHAND);
