...
namespace Proud
{
	...
	*/
	...
	public:
		...
		Allocates memory. The allocated memory can be balalnced to either Realloc or Free.
		...
		*/
		...
		\~english TODO:translate needed.
		Re-allocates memory. Must refer the returned pointer value since re-allocated memory can change its location.
