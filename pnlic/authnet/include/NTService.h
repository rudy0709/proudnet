...
#pragma managed(push, off)
	...
	*/
	class CNTService:protected CSingleton<CNTService>
	{
		CNTServiceInternal* m_internal;

		static void WINAPI _ServiceMain(DWORD dwArgc, TCHAR** lpszArgv);
		...
		void Log(int type, const TCHAR* fmt, ...);
	...
	public:
		...
		*/
		...
		void FrequentWarning(const TCHAR* text);
		void FrequentWarningWithCallStack(const TCHAR* text);
