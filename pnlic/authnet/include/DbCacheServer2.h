...
#pragma managed(push, off)
	...
	*/
	...
	public:
		...
		\param errorinfo Information of  error.
	...
	public:
		...
		*/
		...
		\~english
		Whether to allow or not to allow a non-exclusive access to DBCacheServer. This is a \ref dbc2_nonexclusive_overview function.
		- The default value is false.

		\~chinese
		是否允许与DBCacheServer2的非独占接近。是\ref dbc2_nonexclusive_overview%功能。
		- 默认为false。

		\~japanese
		DBCacheServer2に非独占的接近を許容するかどうかに対するセッティングの値です。 \ref dbc2_nonexclusive_overview 機能です。
		- 基本的に falseです。
	...
	public:
		...
		\~english TODO:translate needed
		Activates the connection from client then starts actual connection to DBMS
		\param params
