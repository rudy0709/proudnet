...
namespace Proud
{
	...
	*/
	...
	public:
		...
		It will be called when error is occured internally.
		\param errorInfo Error message string
		...
		*/
		...
		\param result Type of alram
		\param remote What kind of remote host
		\param where Where it occur from
		...
		*/
		...
		\~english TODO:translate needed.
		It will be called when internal alram is occured. It means tracking situation of internal, not warning situation.
		\param result Type of alram
		\param remote What kind of remote host
		\param where Where it occur from
		...
		*/
		...
		Please refer to \ref send_user_message for more detail.
		...
		*/
		...
		\~chinese
		每隔一段时间在user worker thread pool回调的函数。\ref server_timer_callback  功能。
