...
*/
	enum ServerUdpAssignMode
	{
		...
		*/
		...
		- 본 옵션 사용시 방화벽 설정이 필요합니다. 자세한 것은 \ref block_icmp 를 참고하십시오.
		이 값은 Proud.CStartServerParameter.m_udpPorts 에도 영향을 미칩니다.
		...
		- It is necessary to use a firewall setup to use this feature. Please refer \ref block_icmp for more details.
		This value affects Proud.CStartServerParameter.m_udpPorts also.
		...
		- 使用此选项时需要防火墙设置。详细请参考\ref block_icmp%。
		此值也对 Proud.CStartServerParameter.m_udpPorts%产生影响。
