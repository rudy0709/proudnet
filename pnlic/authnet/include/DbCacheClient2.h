	...
	*/
	...
	public:
		...
		*/
		...
		/**
		\~korean
		다른 DB cache client2가 \ref exclusive_load 을 시도하는 바람에 이미 로딩했던 데이터의 독점 접근 권한을 소실할 것인지 결정할수 있는 이벤트 입니다.
		...
		\~english
		This is event that decide losing exclusive loading or not because other DB cahce client2 tried \ref exclusive_load
		...
		\~chinese
		因为其他DB cache client2试图 \ref exclusive_load%，决定是否丢失已经加载的数据独占接近权限的event。
		...
		*/
		...
		\ref dbc2_isolate_overview 를 하려고 하는 경우에는 불가피하게 이 함수가 콜백됩니다.
		...
		*/
		...
		\~japanese
		\ref dbc2_isolate_overview 機能です。
		...
		*/
		...
		/**
		\~korean
		비독점적 접근에 대한 콜백. \ref dbc2_nonexclusive_overview 참고.
		...
		\~english
		A callback to non monopolistic approach. Please refer to \ref dbc2_nonexclusive_overview.
		...
		\~chinese
		对非独占性接近的回调。请参考\ref dbc2_nonexclusive_overview%。
		...
		\~japanese
		非独占的接近に対するコールバック \ref dbc2_nonexclusive_overview 参考
	...
	*/
	...
	public:
		...
		*/
		...
		\~english
		\ref exclusive_load request method.
		...
		*/
		...
		\~english
		\ref exclusive_load it is a request method.
		...
		*/
		...
		\param updateData TODO:translate needed.
		\param timeOutTime Waiting time to prevent unlimited roop. default 30sec
		\param outError Error type
		...
		*/
		...
		\~english
		Refer to BlockedNonCacheAddData
		\param rootUUID TODO:translate needed.
		\param removeUUID TODO:translate needed.
		\param timeOutTime Waiting time to prevent unlimited roop. default 30sec
		\param outError Error type
		...
		*/
		...
		이 함수 대신 \ref dbc2_isolate_overview 기능을 사용하십시오.
		...
		you need to use \ref dbc2_isolate_overview function instead of this function.
		...
		请用 \ref dbc2_isolate_overview 功能代替此函数。
		...
		この関数の代わりに \ref dbc2_isolate_overviewの機能を使用してください。
		...
		*/
		...
		/**
		\~korean
		비독점적으로 data의 최신 상태를 얻어옵니다. \ref dbc2_nonexclusive_overview 기능입니다. \n
		Callback:
		...
		\~english
		Gets the latest status value as non-exclusively. \ref pndb_nonexclusive_access function.
		...
		\~chinese
		非独占性的获取最新的状态。是\ref pndb_nonexclusive_access%技能。\n
		Callback:
		- IDbCacheClientDelegate2::OnNonExclusiveSnapshotDataSuccess (CCallbackArgs args)
		- IDbCacheClientDelegate2::OnNonExclusiveSnapshotDataFailed (CCallbackArgs args)
		...
		*/
		...
		/**
		\~korean
		비독점적으로 data의 최신 상태를 얻어옵니다. \ref pndb_nonexclusive_access 기능입니다. \n
		Callback:
		- IDbCacheClientDelegate2::OnNonExclusiveSnapshotDataSuccess (CCallbackArgs args)
		- IDbCacheClientDelegate2::OnNonExclusiveSnapshotDataFailed (CCallbackArgs args)
		...
		*/
		...
		\~english
		Gets the latest status value as non-exclusively. \ref dbc2_nonexclusive_overview function.
		Callback:
		- IDbCacheClientDelegate2::OnNonExclusiveSnapshotDataSuccess (CCallbackArgs args)
		- IDbCacheClientDelegate2::OnNonExclusiveSnapshotDataFailed (CCallbackArgs args)
		...
		\~chinese
		非独占性的获取最新的状态。是\ref dbc2_nonexclusive_overview%技能。\n
		Callback:
		- IDbCacheClientDelegate2::OnNonExclusiveSnapshotDataSuccess (CCallbackArgs args)
		- IDbCacheClientDelegate2::OnNonExclusiveSnapshotDataFailed (CCallbackArgs args)
		...
		\~japanese
		非独占的に dataの最新状態を読み込みます。 \ref dbc2_nonexclusive_overview 機能です。\n
		Callback:
		- IDbCacheClientDelegate2::OnNonExclusiveSnapshotDataSuccess (CCallbackArgs args)
		- IDbCacheClientDelegate2::OnNonExclusiveSnapshotDataFailed (CCallbackArgs args)
		...
		*/
		...
		/**
		\~korean
		\ref dbc2_nonexclusive_overview 기능입니다.
		Callback:
		...
		\~english
		\ref dbc2_nonexclusive_overview function.
		Callback:
		- IDbCacheClientDelegate2::OnNonExclusiveAddDataAck (CCallbackArgs args)
		...
		\~chinese
		是\ref dbc2_nonexclusive_overview%功能。
		Callback:
		- IDbCacheClientDelegate2::OnNonExclusiveAddDataAck (CCallbackArgs args)
		...
		\~japanese
		\ref dbc2_nonexclusive_overview 機能です。
		Callback:
		- IDbCacheClientDelegate2::OnNonExclusiveAddDataAck (CCallbackArgs args)
		...
		*/
		...
		\~english TODO:translate needed.
		It is same as above but find it with rootUUID
