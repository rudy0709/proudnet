...
// 		Proud::ErrorType _INTERNAL_NOACCESSMODE_InsertSiblingBefore(CPropNodePtr sibling, CPropNodePtr newNode);
    ...
    public:
		...
		*/
		...
		\~english TODO:translate needed.
		Extracts CPropNode object that is already attached to this object
		The child of extracted node will also be extracted from CPropForest. But the extracted children of the nodes will keep parent-child relationship.

		\param node node to be extracted. Must be dependent to this CPropForest. If not, an error value will be returned.
		...
		*/
		...
		\~english TODO:translate needed.
		It works like RemoveNode(node) but act with UUID.
