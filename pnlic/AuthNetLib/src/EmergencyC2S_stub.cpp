			...
			case Rmi_EmergencyLogData_Begin:
				{
					...
					int64_t loggingTime; __msg >> loggingTime;
					...
					if(!m_internalUse)
					{
						if(m_enableStubProfiling)
						{
							...
							__summary.m_rmiID = (::Proud::RmiID)Rmi_EmergencyLogData_Begin;
							__summary.m_rmiName = RmiName_EmergencyLogData_Begin;
			...
			case Rmi_EmergencyLogData_Error:
				{
					...
					if(!m_internalUse)
					{
						...
						{
							::Proud::BeforeRmiSummary __summary;
							__summary.m_rmiID = (::Proud::RmiID)Rmi_EmergencyLogData_Error;
							__summary.m_rmiName = RmiName_EmergencyLogData_Error;
							__summary.m_hostID = remote;
							__summary.m_hostTag = hostTag;
							BeforeRmiInvocation(__summary);
							__t0 = ::Proud::GetPreciseCurrentTimeMs();
			...
			case Rmi_EmergencyLogData_Stats:
				{
					...
					if(!m_internalUse)
					{
						...
						{
							::Proud::BeforeRmiSummary __summary;
							__summary.m_rmiID = (::Proud::RmiID)Rmi_EmergencyLogData_Stats;
							__summary.m_rmiName = RmiName_EmergencyLogData_Stats;
							__summary.m_hostID = remote;
							__summary.m_hostTag = hostTag;
							BeforeRmiInvocation(__summary);
							__t0 = ::Proud::GetPreciseCurrentTimeMs();
			...
			case Rmi_EmergencyLogData_OSVersion:
				{
					...
					if(!m_internalUse)
					{
						...
						{
							::Proud::BeforeRmiSummary __summary;
							__summary.m_rmiID = (::Proud::RmiID)Rmi_EmergencyLogData_OSVersion;
							__summary.m_rmiName = RmiName_EmergencyLogData_OSVersion;
							__summary.m_hostID = remote;
							__summary.m_hostTag = hostTag;
							BeforeRmiInvocation(__summary);
							__t0 = ::Proud::GetPreciseCurrentTimeMs();
			...
			case Rmi_EmergencyLogData_LogEvent:
				{
					...
					if(!m_internalUse)
					{
						...
						{
							::Proud::BeforeRmiSummary __summary;
							__summary.m_rmiID = (::Proud::RmiID)Rmi_EmergencyLogData_LogEvent;
							__summary.m_rmiName = RmiName_EmergencyLogData_LogEvent;
							__summary.m_hostID = remote;
							__summary.m_hostTag = hostTag;
							BeforeRmiInvocation(__summary);
							__t0 = ::Proud::GetPreciseCurrentTimeMs();
			...
			case Rmi_EmergencyLogData_End:
				{
					...
					if(!m_internalUse)
					{
						...
						{
							::Proud::BeforeRmiSummary __summary;
							__summary.m_rmiID = (::Proud::RmiID)Rmi_EmergencyLogData_End;
							__summary.m_rmiName = RmiName_EmergencyLogData_End;
							__summary.m_hostID = remote;
							__summary.m_hostTag = hostTag;
							BeforeRmiInvocation(__summary);
							__t0 = ::Proud::GetPreciseCurrentTimeMs();
