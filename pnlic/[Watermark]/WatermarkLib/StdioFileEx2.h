// StdioFileEx.h: interface for the CStdioFileEx2 class.
//
...
// #ifdef _UNICODE
// #else
// #error This source is only complied Unicode mode.
// #endif
...
class CStdioFileEx2: public CStdioFile
{
public:
	CStdioFileEx2();
	CStdioFileEx2( LPCTSTR lpszFileName, UINT nOpenFlags );

	virtual BOOL	Open( LPCTSTR lpszFileName, UINT nOpenFlags, CFileException* pError = NULL );
	virtual void	Close();
	virtual BOOL	ReadString(CString& rString);
	virtual void	WriteString( LPCTSTR lpsz );
	encodeType		GetFileEncodeType()	{ return m_encodeType; }	
	...
	// Exceptions:	None.
	//
	static encodeType FileEncodetype(const CString& sFilePath);
