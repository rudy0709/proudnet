			...
			case Rmi_RequestCredential:
				{
					...
					if(!m_internalUse)
					{
						if(m_enableStubProfiling)
						{
							...
							__summary.m_rmiID = (::Proud::RmiID)Rmi_RequestCredential;
							__summary.m_rmiName = RmiName_RequestCredential;
			...
			case Rmi_ReportStatusBegin:
				{
					...
					if(!m_internalUse)
					{
						...
						{
							::Proud::BeforeRmiSummary __summary;
							__summary.m_rmiID = (::Proud::RmiID)Rmi_ReportStatusBegin;
							__summary.m_rmiName = RmiName_ReportStatusBegin;
							__summary.m_hostID = remote;
							__summary.m_hostTag = hostTag;
							BeforeRmiInvocation(__summary);
							__t0 = ::Proud::GetPreciseCurrentTimeMs();
			...
			case Rmi_ReportStatusValue:
				{
					...
					if(!m_internalUse)
					{
						...
						{
							::Proud::BeforeRmiSummary __summary;
							__summary.m_rmiID = (::Proud::RmiID)Rmi_ReportStatusValue;
							__summary.m_rmiName = RmiName_ReportStatusValue;
							__summary.m_hostID = remote;
							__summary.m_hostTag = hostTag;
							BeforeRmiInvocation(__summary);
							__t0 = ::Proud::GetPreciseCurrentTimeMs();
			...
			case Rmi_ReportStatusEnd:
				{
					...
					if(!m_internalUse)
					{
						...
						{
							::Proud::BeforeRmiSummary __summary;
							__summary.m_rmiID = (::Proud::RmiID)Rmi_ReportStatusEnd;
							__summary.m_rmiName = RmiName_ReportStatusEnd;
							__summary.m_hostID = remote;
							__summary.m_hostTag = hostTag;
							BeforeRmiInvocation(__summary);
							__t0 = ::Proud::GetPreciseCurrentTimeMs();
			...
			case Rmi_ReportServerAppState:
				{
					...
					if(!m_internalUse)
					{
						...
						{
							::Proud::BeforeRmiSummary __summary;
							__summary.m_rmiID = (::Proud::RmiID)Rmi_ReportServerAppState;
							__summary.m_rmiName = RmiName_ReportServerAppState;
							__summary.m_hostID = remote;
							__summary.m_hostTag = hostTag;
							BeforeRmiInvocation(__summary);
							__t0 = ::Proud::GetPreciseCurrentTimeMs();
			...
			case Rmi_EventLog:
				{
					...
					if(!m_internalUse)
					{
						...
						{
							::Proud::BeforeRmiSummary __summary;
							__summary.m_rmiID = (::Proud::RmiID)Rmi_EventLog;
							__summary.m_rmiName = RmiName_EventLog;
							__summary.m_hostID = remote;
							__summary.m_hostTag = hostTag;
							BeforeRmiInvocation(__summary);
							__t0 = ::Proud::GetPreciseCurrentTimeMs();
