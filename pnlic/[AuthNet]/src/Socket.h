...
namespace Proud
{
	...
	private:
		...
		FastSocketPtr m_internalSocket;	
		// Socket Delegate
	...
	public:
		CSocketImpl(SOCKET auxSocket, ISocketDelegate* dg);
...
#if !defined(_WIN32)
//         SocketErrorCode NonBlockedRecvFrom(int length); 쓰지 말 것
// 		SocketErrorCode NonBlockedSendTo( BYTE* data, int count, AddrPort sendTo );
// 		SocketErrorCode NonBlockedRecv(int length);
