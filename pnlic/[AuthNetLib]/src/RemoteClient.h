...
namespace Proud
{
	...
	{
	public:
		bool m_hackSuspected;
		int64_t m_lastPingReceivedTimeMs;
		int64_t m_firstPingReceivedTimeMs;
		int64_t m_recentPingIntervalMs;
	...
	class P2PConnectionStatePtrTraits
	{
	public:
		typedef const P2PConnectionStatePtr& INARGTYPE;
		typedef P2PConnectionStatePtr& OUTARGTYPE;

		inline static uint32_t Hash( INARGTYPE element ) 
		{		
			return CPNElementTraits<uintptr_t>::Hash((uintptr_t)element.get());
		}
...
//		bool m_purgeRequested;
		...
		typedef CFastSet<P2PConnectionStatePtr,P2PConnectionStatePtrTraits> P2PConnectionPairs;
