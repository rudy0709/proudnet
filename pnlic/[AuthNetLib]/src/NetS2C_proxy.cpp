...
namespace ProudS2C {
	...
	bool Proxy::P2PGroup_MemberJoin ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext , const HostID & groupHostID, const HostID & memberHostID, const ByteArray & customField, const int & eventID, const ByteArray & p2pAESSessionKey, const ByteArray & p2pFastSessionKey, const int & p2pFirstFrameNumber, const Proud::Guid & connectionMagicNumber, const bool & allowDirectP2P, const bool & pairRecycled)	{
...
__msg << pairRecycled;
	...
	bool Proxy::P2PGroup_MemberJoin ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext, const HostID & groupHostID, const HostID & memberHostID, const ByteArray & customField, const int & eventID, const ByteArray & p2pAESSessionKey, const ByteArray & p2pFastSessionKey, const int & p2pFirstFrameNumber, const Proud::Guid & connectionMagicNumber, const bool & allowDirectP2P, const bool & pairRecycled)  	{
...
__msg << pairRecycled;
	...
	bool Proxy::RequestP2PHolepunch ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext , const HostID & remotePeerID, const AddrPort & internalAddr, const AddrPort & externalAddr)	{
...
__msg << externalAddr;
	...
	bool Proxy::RequestP2PHolepunch ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext, const HostID & remotePeerID, const AddrPort & internalAddr, const AddrPort & externalAddr)  	{
...
__msg << externalAddr;
	...
	bool Proxy::P2P_NotifyDirectP2PDisconnected2 ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext , const HostID & remotePeerHostID, const ErrorType & reason)	{
...
__msg << reason;
	...
	bool Proxy::P2P_NotifyDirectP2PDisconnected2 ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext, const HostID & remotePeerHostID, const ErrorType & reason)  	{
...
__msg << reason;
	...
	bool Proxy::P2P_NotifyP2PMemberOffline ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext , const HostID & remotePeerHostID)	{
...
__msg << remotePeerHostID;
	...
	bool Proxy::P2P_NotifyP2PMemberOffline ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext, const HostID & remotePeerHostID)  	{
...
__msg << remotePeerHostID;
	...
	bool Proxy::P2P_NotifyP2PMemberOnline ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext , const HostID & remotePeerHostID)	{
...
__msg << remotePeerHostID;
	...
	bool Proxy::P2P_NotifyP2PMemberOnline ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext, const HostID & remotePeerHostID)  	{
...
__msg << remotePeerHostID;
	...
	bool Proxy::P2PGroup_MemberLeave ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext , const HostID & memberHostID, const HostID & groupHostID)	{
...
__msg << groupHostID;
	...
	bool Proxy::P2PGroup_MemberLeave ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext, const HostID & memberHostID, const HostID & groupHostID)  	{
...
__msg << groupHostID;
	...
	bool Proxy::NotifyDirectP2PEstablish ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext , const HostID & aPeer, const HostID & bPeer, const AddrPort & X0, const AddrPort & Y0, const AddrPort & Z0, const AddrPort & W0)	{
...
__msg << W0;
	...
	bool Proxy::NotifyDirectP2PEstablish ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext, const HostID & aPeer, const HostID & bPeer, const AddrPort & X0, const AddrPort & Y0, const AddrPort & Z0, const AddrPort & W0)  	{
...
__msg << W0;
	...
	bool Proxy::ReliablePong ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext , const int & localTimeMs, const int & messageID)	{
...
__msg << messageID;
	...
	bool Proxy::ReliablePong ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext, const int & localTimeMs, const int & messageID)  	{
...
__msg << messageID;
	...
	bool Proxy::EnableLog ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext )	{
...
__msg.Write(__msgid);
	...
	bool Proxy::EnableLog ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext)  	{
...
__msg.Write(__msgid);
	...
	bool Proxy::DisableLog ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext )	{
...
__msg.Write(__msgid);
	...
	bool Proxy::DisableLog ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext)  	{
...
__msg.Write(__msgid);
	...
	bool Proxy::NotifyUdpToTcpFallbackByServer ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext )	{
...
__msg.Write(__msgid);
	...
	bool Proxy::NotifyUdpToTcpFallbackByServer ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext)  	{
...
__msg << enable;
	...
	bool Proxy::ShutdownTcpAck ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext )	{
...
__msg.Write(__msgid);
	...
	bool Proxy::ShutdownTcpAck ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext)  	{
...
__msg.Write(__msgid);
	...
	bool Proxy::RequestAutoPrune ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext )	{
...
__msg.Write(__msgid);
	...
	bool Proxy::RequestAutoPrune ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext)  	{
