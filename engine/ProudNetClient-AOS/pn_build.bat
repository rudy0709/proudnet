...
$rem 빌드 시에 생성되었으나, clean으로 제거되지 않은 디렉토리를 삭제
rd /s /q app\.cxx\
rd /s /q build\
...
:build
@rem @rem .pidl, ErrorType.yaml 파일을 컴파일합니다.
@rem ..\..\utils\Pidl\bin\Release\PIDL_UnProtect.exe ..\ProudNetPidlBuild\*.pidl -outdir ..\src\
@rem ..\..\utils\Pidl\bin\Release\PIDL_UnProtect.exe ..\ProudNetPidlBuild\ErrorType.yaml -outdir ..\src\ -incdir ..\include\
