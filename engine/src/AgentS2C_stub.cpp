			...
			case Rmi_NotifyCredential:
			    {
			        ...
			        if(!m_internalUse && m_enableStubProfiling)
			        {
			            ...
			            summary.m_rmiID = (::Proud::RmiID)Rmi_NotifyCredential;
			            summary.m_rmiName = RmiName_NotifyCredential;
			...
			case Rmi_RequestServerAppStop:
			    {
			        ...
			        {
			            ::Proud::BeforeRmiSummary summary;
			            summary.m_rmiID = (::Proud::RmiID)Rmi_RequestServerAppStop;
			            summary.m_rmiName = RmiName_RequestServerAppStop;
			            summary.m_hostID = remote;
			            summary.m_hostTag = hostTag;
			            BeforeRmiInvocation(summary);
