...
public class NativeHostIDArray : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          ProudNetServerPluginPINVOKE.delete_NativeHostIDArray(swigCPtr);
        }
  ...
  private void add(HostID data) {
    ProudNetServerPluginPINVOKE.NativeHostIDArray_add(swigCPtr, (int)data);
  ...
  public void Clear(HostID data) {
    ProudNetServerPluginPINVOKE.NativeHostIDArray_Clear(swigCPtr, (int)data);
    if (ProudNetServerPluginPINVOKE.SWIGPendingException.Pending) throw ProudNetServerPluginPINVOKE.SWIGPendingException.Retrieve();
  }

  public int GetCount() {
    int ret = ProudNetServerPluginPINVOKE.NativeHostIDArray_GetCount(swigCPtr);
    if (ProudNetServerPluginPINVOKE.SWIGPendingException.Pending) throw ProudNetServerPluginPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private HostID at(int index) {
    HostID ret = (HostID)ProudNetServerPluginPINVOKE.NativeHostIDArray_at(swigCPtr, index);
    if (ProudNetServerPluginPINVOKE.SWIGPendingException.Pending) throw ProudNetServerPluginPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public NativeHostIDArray() : this(ProudNetServerPluginPINVOKE.new_NativeHostIDArray(), true) {
    if (ProudNetServerPluginPINVOKE.SWIGPendingException.Pending) throw ProudNetServerPluginPINVOKE.SWIGPendingException.Retrieve();
  }
