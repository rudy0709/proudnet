			...
			case Rmi_NotifyCommon_SendRmi:
				{
					...
					{
						::Proud::BeforeRmiSummary summary;
						summary.m_rmiID = (::Proud::RmiID)Rmi_NotifyCommon_SendRmi;
						summary.m_rmiName = RmiName_NotifyCommon_SendRmi;
						summary.m_hostID = remote;
						summary.m_hostTag = hostTag;
						BeforeRmiInvocation(summary);
			...
			case Rmi_NotifyCommon_ReceiveRmi:
				{
					...
					{
						::Proud::BeforeRmiSummary summary;
						summary.m_rmiID = (::Proud::RmiID)Rmi_NotifyCommon_ReceiveRmi;
						summary.m_rmiName = RmiName_NotifyCommon_ReceiveRmi;
						summary.m_hostID = remote;
						summary.m_hostTag = hostTag;
						BeforeRmiInvocation(summary);
			...
			case Rmi_NotifyCli_ConnectionState:
				{
					...
					{
						::Proud::BeforeRmiSummary summary;
						summary.m_rmiID = (::Proud::RmiID)Rmi_NotifyCli_ConnectionState;
						summary.m_rmiName = RmiName_NotifyCli_ConnectionState;
						summary.m_hostID = remote;
						summary.m_hostTag = hostTag;
						BeforeRmiInvocation(summary);
			...
			case Rmi_NotifyCli_Peers_Clear:
				{
					...
					{
						::Proud::BeforeRmiSummary summary;
						summary.m_rmiID = (::Proud::RmiID)Rmi_NotifyCli_Peers_Clear;
						summary.m_rmiName = RmiName_NotifyCli_Peers_Clear;
						summary.m_hostID = remote;
						summary.m_hostTag = hostTag;
						BeforeRmiInvocation(summary);
			...
			case Rmi_NotifyCli_Peers_AddOrEdit:
				{
					...
					{
						::Proud::BeforeRmiSummary summary;
						summary.m_rmiID = (::Proud::RmiID)Rmi_NotifyCli_Peers_AddOrEdit;
						summary.m_rmiName = RmiName_NotifyCli_Peers_AddOrEdit;
						summary.m_hostID = remote;
						summary.m_hostTag = hostTag;
						BeforeRmiInvocation(summary);
			...
			case Rmi_NotifySrv_ClientEmpty:
				{
					...
					{
						::Proud::BeforeRmiSummary summary;
						summary.m_rmiID = (::Proud::RmiID)Rmi_NotifySrv_ClientEmpty;
						summary.m_rmiName = RmiName_NotifySrv_ClientEmpty;
						summary.m_hostID = remote;
						summary.m_hostTag = hostTag;
						BeforeRmiInvocation(summary);
			...
			case Rmi_NotifySrv_Clients_AddOrEdit:
				{
					...
					{
						::Proud::BeforeRmiSummary summary;
						summary.m_rmiID = (::Proud::RmiID)Rmi_NotifySrv_Clients_AddOrEdit;
						summary.m_rmiName = RmiName_NotifySrv_Clients_AddOrEdit;
						summary.m_hostID = remote;
						summary.m_hostTag = hostTag;
						BeforeRmiInvocation(summary);
			...
			case Rmi_NotifySrv_Clients_Remove:
				{
					...
					{
						::Proud::BeforeRmiSummary summary;
						summary.m_rmiID = (::Proud::RmiID)Rmi_NotifySrv_Clients_Remove;
						summary.m_rmiName = RmiName_NotifySrv_Clients_Remove;
						summary.m_hostID = remote;
						summary.m_hostTag = hostTag;
						BeforeRmiInvocation(summary);
			...
			case Rmi_NotifyLoginOk:
				{
					...
					{
						::Proud::BeforeRmiSummary summary;
						summary.m_rmiID = (::Proud::RmiID)Rmi_NotifyLoginOk;
						summary.m_rmiName = RmiName_NotifyLoginOk;
						summary.m_hostID = remote;
						summary.m_hostTag = hostTag;
						BeforeRmiInvocation(summary);
