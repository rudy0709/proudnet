...
namespace Proud
{
	//////////////////////////////////////////////////////////////////////////
	// req - ack method
	void CDbCacheClient2Impl::RequestExclusiveLoadData(String rootTableName, String fieldName, CVariant cmpValue, intptr_t tag, const ByteArray& message)
	{
	...
	{
		// MS SQL에서는 대소문자를 구별 안해서 이렇게 한다.
		// TODO: MySQL은 구별한다. 이거 나중에 고쳐야 한다.
		rootTableName.MakeUpper();
	...
	void CDbCacheClient2Impl::RequestExclusiveLoadDataByQuery(String rootTableName, String queryString, intptr_t tag, const ByteArray &message)
	{
		rootTableName.MakeUpper();
	...
	void CDbCacheClient2Impl::RequestExclusiveLoadNewData(String rootTableName, CPropNodePtr addData, intptr_t tag, bool transaction)
	{
		...
		addData->SetTypeName(rootTableName.GetString());
	...
	DEFRMI_DB2S2C_NotifyLoadDataComplete(CDbCacheClient2Impl)
	{
		...
		//#RequestExclusiveLoadDataByGuid 8 드디어 유저 콜백 처리
	...
	//////////////////////////////////////////////////////////////////////////
	// unload method
	bool CDbCacheClient2Impl::UnloadDataBySessionGuid(Guid sessionGuid, const ByteArray& messageToNextLoader)
	{
		CriticalSectionLock lock(m_cs, true);
	...
	void CDbCacheClient2Impl::DenyUnloadData(Guid sessionGuid, const ByteArray& messageToRequester)
	{
		CriticalSectionLock lock(m_cs, true);
