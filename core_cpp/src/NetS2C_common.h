...
namespace ProudS2C {
    ...
    static const ::Proud::RmiID Rmi_NotifyChangedTimeoutTime = (::Proud::RmiID)(63000+19);
               
    static const ::Proud::RmiID Rmi_NotifyChangedAutoConnectionRecoveryTimeoutTimeMs = (::Proud::RmiID)(63000+20);
               
    static const ::Proud::RmiID Rmi_RoundTripLatencyPong = (::Proud::RmiID)(63000+21);
