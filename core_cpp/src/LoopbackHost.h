...
namespace Proud
{
	...
	class CLoopbackHost_C : public CHostBase, public IP2PGroupMember
	{
	public:
		CLoopbackHost_C(CNetClientImpl* owner, HostID hostID);
		~CLoopbackHost_C();
		...
		virtual int64_t GetIndirectServerTimeDiff();
